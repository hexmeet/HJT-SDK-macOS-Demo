...
@implementation NSImage (resizableImage)
...
- (NSImage *)stretchableImageWithSize:(NSSize)size edgeInsets:(NSEdgeInsets)insets
{
    ...
    for (int i=0;i<9;i++)
    {
        ...
        [partImg lockFocus];
        [self drawAtPoint:NSZeroPoint fromRect:aSrcRect operation:NSCompositingOperationCopy fraction:1.0];
