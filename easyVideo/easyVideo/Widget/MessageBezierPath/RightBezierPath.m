...
#import "RightBezierPath.h"

@implementation RightBezierPath
...
- (void)drawRect:(NSRect)dirtyRect {
    ...
    bezier = [self makeBubble:bezier withBubbleRect:NSMakeRect(0, 0, self.bounds.size.width-10, self.bounds.size.height) corner:5 atPostion:3];

    [HEXCOLOR(0x80aaff) set];
    [bezier fill];
