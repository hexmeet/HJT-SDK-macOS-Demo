...
#import "LeftBezierPath.h"

@implementation LeftBezierPath
...
- (void)drawRect:(NSRect)dirtyRect {
    ...
    bezier = [self makeBubble:bezier withBubbleRect:NSMakeRect(10, 0, self.bounds.size.width-10, self.bounds.size.height) corner:5 atPostion:1];

    [HEXCOLOR(0xf3f3f3) set];
    [bezier fill];
